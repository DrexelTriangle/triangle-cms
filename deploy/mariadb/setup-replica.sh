...
echo
echo " 3. Fence the write path: DROP USER 'triangle_user'@'10.248.40.168' and"
echo "    firewall 3306 to the MaxScale host and the DB peer. Have console"
echo "    access open; the DB firewalls are currently wide open."
echo
echo " 4. On the MaxScale host, set REPLICA_HOST in"
...
echo
echo " 5. Confirm 'maxctrl list servers' shows Master, Running and Slave,"
